...
<main id="main-content" class="main-content flex-grow p-8 shifted ml-56">
    <div class="container mx-auto">
        ...
        <div class="mb-4 mx-8 flex space-x-20">
            ...
            <select id="type-filtre" class="type-filtre bg-blue-500 text-white px-4 py-2 rounded-md">
                    ...
                    <?php foreach ($cargaisons as $cargaison) : ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <button class="bg-blue-500 text-white px-1 py-1 rounded btn-fermer-cargo" type="button" data-id="<?php echo $cargaison['numero']; ?>"><i class="fas fa-solid fa-lock"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <form id="form-add-produit">
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 ml-4">
                        ...
                        <input type="text" id="nom-produit" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="[A-Za-z\s]+" title="Le nom de cargaison ne doit contenir que des lettres et des espaces" required>
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <input type="number" id="poids-produit" class="mt-1 block w-full p-2 border border-gray-300 rounded" min="1" required>
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 mr-4">
                        ...
                        <select id="type-produit" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 mr-4">
                        ...
                        <select id="etape-produit" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    ...
                    <div class="flex-1 mr-4">
                        ...
                        <input type="text" id="prenom-client" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="[A-Za-z\s]+" title="Le prénom ne doit contenir que des lettres " required>
                        <span class="text-red-500 text-sm hidden" id="prenom-client-error">Prénom client est obligatoire et ne doit contenir que des lettres et des espaces</span>
                    </div>
                </div>
                ...
                <div class="mb-4 flex"> 
                    <div class="flex-1 mr-4">
                        ...
                        <input type="text" id="nom-client" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="[A-Za-z\s]+" title="Le nom ne doit contenir que des lettres   " required>
                        <span class="text-red-500 text-sm hidden" id="nom-client-error">Nom client est obligatoire et ne doit contenir que des lettres et des espaces</span>
                    </div>
                    <div class="flex-1 ml-4">
                        <label for="telephone-client" class="block text-sm font-medium text-gray-700">Téléphone du client</label>
                        <input type="number" id="telephone-client" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="\d{9,12}" title="Le numéro de téléphone doit comporter entre 9 et 12 chiffres" required>
                        <span class="text-red-500 text-sm hidden" id="telephone-client-error">Numéro de téléphone est obligatoire et doit comporter entre 9 et 12 chiffres</span>
                    </div>
                </div>
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 mr-4">
                        ...
                        <input type="email" id="email-client" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <input type="text" id="nom-destinateur" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="[A-Za-z\s]+" title="Le nom ne doit contenir que des lettres et des espaces" required>
                        <span class="text-red-500 text-sm hidden" id="nom-destinateur-error">Nom du destinateur est obligatoire et ne doit contenir que des lettres et des espaces</span>
                    </div>
                </div>
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 mr-4">
                        ...
                        <input type="text" id="prenom-destinateur" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="[A-Za-z\s]+" title="Le prénom ne doit contenir que des lettres et des espaces" required>
                        <span class="text-red-500 text-sm hidden" id="prenom-destinateur-error">Prénom du destinateur est obligatoire et ne doit contenir que des lettres et des espaces</span>
                    </div>
                    <div class="flex-1 ml-4">
                        <label for="telephone-destinateur" class="block text-sm font-medium text-gray-700">Numéro de téléphone du destinateur</label>
                        <input type="number" id="telephone-destinateur" class="mt-1 block w-full p-2 border border-gray-300 rounded" pattern="\d{9,12}" title="Le numéro de téléphone doit comporter entre 9 et 12 chiffres" required>
                        <span class="text-red-500 text-sm hidden" id="telephone-destinateur-error">Numéro de téléphone est obligatoire et doit comporter entre 9 et 12 chiffres</span>
                    </div>
                </div>
                ...
                <div class="mb-4 flex">
                    <div class="flex-1 mr-4">
                        ...
                        <input type="email" id="email-destinateur" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <input type="text" id="adresse-destinateur" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
